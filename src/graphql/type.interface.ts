...
export type CreateMaintenanceAccessory = {
  name: Scalars['String'];
  quantity: Scalars['Float'];
  unit: Scalars['String'];
};
...
export type CreateMaintenanceInput = {
  ...
  startDate: Scalars['DateTime'];
  vehicleId: Scalars['String'];
  vehicleTypeCategoryId?: InputMaybe<Scalars['String']>;
};
...
export type CreateVehicleTypeCategory = {
  maintenanceAccessories: Array<CreateMaintenanceAccessory>;
  modelId: Scalars['String'];
  operatingNumber: Scalars['Float'];
  vehicleTypeId: Scalars['String'];
};
...
export type MaintenanceAccessoryEntity = Node & {
  ...
  accessoryName?: Maybe<Scalars['String']>;
  createdAt: Scalars['DateTime'];
  id: Scalars['ID'];
...
export type MaintenanceEntity = Node & {
  ...
  accessories_available?: Maybe<Array<MaintenanceAccessoryEntity>>;
  addressMoreInfo?: Maybe<Scalars['String']>;
  code: Scalars['String'];
  createdAt: Scalars['DateTime'];
  deletedAt?: Maybe<Scalars['DateTime']>;
  ...
  vehicleId: Scalars['String'];
  vehicleTypeCategory?: Maybe<VechicleTypeCategoryEntity>;
  vehicleTypeCategoryId?: Maybe<Scalars['String']>;
};
...
export type MaintenancesAccessoryEntity = Node & {
  __typename?: 'MaintenancesAccessoryEntity';
  createdAt: Scalars['DateTime'];
  deletedAt?: Maybe<Scalars['DateTime']>;
  id: Scalars['ID'];
  name: Scalars['String'];
...
export type Mutation = {
  ...
  adminCreateVehicleTypeCategory: VechicleTypeCategoryEntity;
  ...
  adminDeleteNews: Scalars['Boolean'];
  ...
  adminRemoveVhicleTypeCategory: Scalars['Boolean'];
  ...
  adminUpdateVehicleTypeCategory: VechicleTypeCategoryEntity;
...
export type MutationAdminCreateVehicleTypeCategoryArgs = {
  input: CreateVehicleTypeCategory;
};
...
export type MutationAdminRemoveVhicleTypeCategoryArgs = {
  id: Scalars['String'];
};
...
export type MutationAdminUpdateVehicleTypeCategoryArgs = {
  input: UpdateVehicleTypeCategory;
};
...
export type Query = {
  ...
  adminBookingSettlements: Array<SettlementEntity>;
  ...
  adminGetVehicleTypeCategories: VechicleTypeCategoryConnection;
  adminGetVehicleTypeCategory: VechicleTypeCategoryEntity;
  adminMaintenance: MaintenanceEntity;
  adminMaintenances: MaintenanceConnection;
  adminNews: NewsConnection;
  adminOrder: OrderEntity;
  adminOrders: OrderConnection;
  adminPartner?: Maybe<PartnerEntity>;
  adminPartners?: Maybe<PartnerConnection>;
  ...
  userGetNews: NewsConnection;
  userGetNewsById: NewsEntity;
  ...
  userGetVehicleTypeCategories: Array<VechicleTypeCategoryEntity>;
  userGetVehicleTypeCategory: VechicleTypeCategoryEntity;
...
export type QueryAdminAgenciesArgs = {
  ...
  filters?: InputMaybe<Array<Scalars['JSONObject']>>;
  includeAdmin?: InputMaybe<Scalars['Boolean']>;
  isActive?: InputMaybe<StatusEnum>;
  isApproved?: InputMaybe<Scalars['Boolean']>;
  limit?: InputMaybe<Scalars['Int']>;
  page?: InputMaybe<Scalars['Int']>;
...
export type QueryAdminBookingSettlementsArgs = {
  bookingId: Scalars['String'];
};
...
export type QueryAdminGetVehicleTypeCategoriesArgs = {
  filters?: InputMaybe<Array<Scalars['JSONObject']>>;
  isActive?: InputMaybe<StatusEnum>;
  isApproved?: InputMaybe<Scalars['Boolean']>;
  limit?: InputMaybe<Scalars['Int']>;
...
export type QueryAdminGetVehicleTypeCategoryArgs = {
  id: Scalars['String'];
};
...
export type QueryAdminNewsArgs = {
  filters?: InputMaybe<Array<Scalars['JSONObject']>>;
  isActive?: InputMaybe<StatusEnum>;
  isApproved?: InputMaybe<Scalars['Boolean']>;
  limit?: InputMaybe<Scalars['Int']>;
...
export type QueryAdminPartnersArgs = {
  agencyId?: InputMaybe<Scalars['String']>;
  filters?: InputMaybe<Array<Scalars['JSONObject']>>;
  includeAdmin?: InputMaybe<Scalars['Boolean']>;
  isActive?: InputMaybe<StatusEnum>;
...
export type QueryAdminProductQuotationsArgs = {
  ...
  partnerId?: InputMaybe<Scalars['String']>;
  productId?: InputMaybe<Scalars['String']>;
  productQuotationCode?: InputMaybe<Scalars['String']>;
...
export type QueryUserGetNewsArgs = {
  filters?: InputMaybe<Array<Scalars['JSONObject']>>;
  isActive?: InputMaybe<StatusEnum>;
  isApproved?: InputMaybe<Scalars['Boolean']>;
  limit?: InputMaybe<Scalars['Int']>;
...
export type QueryUserGetNewsByIdArgs = {
  id: Scalars['String'];
};
...
export type QueryUserGetVehicleTypeCategoriesArgs = {
  input: UserGetVehicleTypeCategories;
};

export type QueryUserGetVehicleTypeCategoryArgs = {
  input: UserGetVehicleTypeCategory;
};
...
export type UpdateMaintenanceAccessory = {
  id: Scalars['String'];
  name?: InputMaybe<Scalars['String']>;
  quantity?: InputMaybe<Scalars['Float']>;
...
export type UpdateVehicleTypeCategory = {
  id: Scalars['String'];
  maintenanceAccessories: Array<UpdateMaintenanceAccessory>;
  operatingNumber: Scalars['Float'];
};
...
export type UserGetVehicleTypeCategories = {
  modelId: Scalars['String'];
  vehicleTypeId: Scalars['String'];
};

export type UserGetVehicleTypeCategory = {
  modelId: Scalars['String'];
  operatingNumber: Scalars['Float'];
  vehicleTypeId: Scalars['String'];
};
...
export type VechicleTypeCategoryConnection = {
  __typename?: 'VechicleTypeCategoryConnection';
  items?: Maybe<Array<VechicleTypeCategoryEntity>>;
  meta: BasePaginationMeta;
};

export type VechicleTypeCategoryEntity = Node & {
  __typename?: 'VechicleTypeCategoryEntity';
  createdAt: Scalars['DateTime'];
  deletedAt?: Maybe<Scalars['DateTime']>;
  id: Scalars['ID'];
  maintenanceAcessories: Array<MaintenancesAccessoryEntity>;
  maintenanceAcessoryIds?: Maybe<Array<Scalars['String']>>;
  model: CategoryEntity;
  modelId: Scalars['String'];
  operatingNumber: Scalars['Float'];
  updatedAt: Scalars['DateTime'];
